define({ "api": [
  ...
  },
  {
    ...
    "description": "<p>獲取熱門搜索詞功能會從關鍵字數據庫中篩選出點擊頻率最高的3~5個關鍵詞進行顯示。</p>",
    "success": {
      "examples": [
        {
          "title": "請求成功",
  ...
  },
  {
    ...
    "description": "<p>主頁面商品顯示，根據登入用戶的歷史行為對所有商品進行打分，進行個性化排序顯示首頁商品。</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "description": "<p>熱門搜索詞檢索，通過點擊熱門關鍵詞檢索相應的商品，每次點擊都會增加該關鍵詞的點擊數。</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "isAnonymous",
            "description": "<p>評價信息:評價是否匿名(true:是，false:否)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  {
    "type": "GET",
    "url": "/help/catalog/question/answer",
    "title": "獲取對應問題解答",
    "name": "ShowHelpAnswer",
    "group": "服務端:幫助管理",
    "permission": [
  ...
  {
    "type": "GET",
    "url": "/help/catalog/questions",
    "title": "獲取相應問題類型的問題",
    "name": "ShowHelpQuestions",
    "group": "服務端:幫助管理",
    "permission": [
      {
        "name": "none"
  ...
  },
  {
    ...
    "description": "<p>獲取輪播圖圖片，客戶端也是共用這個接口</p>",
    "success": {
      "examples": [
        {
          "title": "請求成功",
  ...
  {
    "type": "GET",
    "url": "/my/comment/reports",
    "title": "獲取用戶所有留言舉報",
    "name": "GetUserAllCommentReport",
    "group": "用戶舉報",
    "permission": [
      {
        "name": "none"
  ...
  {
    "type": "GET",
    "url": "/my/product/reports",
    "title": "獲取用戶所有商品舉報",
    "name": "GetUserAllProductReport",
    "group": "用戶舉報",
    "permission": [
      {
        "name": "none"
  ...
  {
    "type": "GET",
    "url": "/my/comment/reports/status",
    "title": "根據處理狀態獲取用戶的留言舉報",
    "name": "GetUserCommentReportByStatus",
    "group": "用戶舉報",
    "permission": [
      {
        "name": "none"
    ...
    "description": "<p>根據處理狀態獲取用戶的留言舉報</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": false,
            "field": "status",
            "description": "<p>舉報處理狀態(0:未處理, 1:已通過, 2:不通過)</p>"
          }
        ]
      }
    },
    "success": {
      "examples": [
        {
          "title": "舉報發送成功(例子:phone = 15059417755,status = 0)",
          "content": "[\n    {\n        \"id\": 1,\n        \"targetName\": \"Jamie Sanders\",\n        \"headPicFormat\": \"jpg\",\n        \"targetHeadPic\": \"iVBORw0KGgoAAAANSUhEUgAAAf8AAAH/CAYAAABZ8dS+AAAABGdBTUEAALGPC/...\",\n        \"commentContent\": \"有需要同問兩次嗎?無語\",\n        \"content\": \"留言不友善\",\n        \"status\": 0\n    },...,{}\n]",
          "type": "json"
        }
      ]
  ...
  {
    "type": "GET",
    "url": "/my/product/reports/status",
    "title": "根據處理狀態獲取用戶的商品舉報",
    "name": "GetUserProductReportByStatus",
    "group": "用戶舉報",
    "permission": [
      {
        "name": "none"
    ...
    "description": "<p>根據處理狀態獲取用戶的商品舉報</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
    ...
    "success": {
      "examples": [
        {
          "title": "舉報發送成功(例子:phone = 15059417755,status = 1)",
          "content": "[\n     {\n         \"id\": 1,\n         \"sellerName\": \"天天\",\n         \"headPicFormat\": \"jpg\",\n         \"sellerHeadPic\": \"iVBORw0KGgoAAAANSUhEUgAAAf8AAAH/CAYAAABZ8dS+AAAABGdBTUEAALGPC/...\",\n         \"productName\": \"連衣裙\",\n         \"coverPicFormat\": \"jpg\",\n         \"productCover\": \"/9j/4AAQSkZJRgABAQAAAQABAAD/2wBDAAMCAgMCAgMDAwMEAwMEBQgFBQQEBQ...\",\n         \"price\": 49.9,\n         \"content\": \"裙子嚴重脫線，洗一次基本就沒法穿了\",\n         \"status\": 1\n     },...,{}\n ]",
          "type": "json"
        }
      ]
