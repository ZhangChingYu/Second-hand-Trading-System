...
var _index = _interopRequireDefault(__webpack_require__(/*! ./pages/applyRefund/index.vue */ 374));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // @ts-ignore
...
/* harmony import */ var _index_vue_vue_type_template_id_78c9ee60___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=78c9ee60& */ 375);
...
var render = function() {
  ...
  var g0 = parseFloat(_vm.order.price).toFixed(2)
  var g1 = parseFloat(_vm.total).toFixed(2)
...
var _mixin = __webpack_require__(/*! ../../mixin.js */ 155);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var _default =
{
  ...
  onLoad: function onLoad(option) {
    this.order = JSON.parse(decodeURIComponent(option.orderGoods));
