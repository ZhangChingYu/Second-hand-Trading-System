...
var _default =
{
  ...
  methods: {
    ...
    // 获取该商品的预约列表
    getOneBookList: function getOneBookList() {var _this4 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {var that, state, res;return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
                that = _this4;
                ...
                //TODO handle the exception
                that.$toast(_context4.t0);case 12:case "end":return _context4.stop();}}}, _callee4, null, [[2, 9]]);}))();
